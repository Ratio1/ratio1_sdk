...
EVM_NET_DATA = {
  ...
  EvmNetData.TESTNET: {
    ...
    EvmNetData.DAUTH_ATTESTATION_REGISTRY_ADDR_KEY: "0x6AEE4B13904B4cbeaCc8e9bBE8e25ed399C3ba69",
  ...
  EvmNetData.DEVNET : {
    ...
    EvmNetData.DAUTH_ATTESTATION_REGISTRY_ADDR_KEY: "0x428ca2fb6e543B5c159d1e6a124B615AeA15f497",
    EvmNetData.DAUTH_RPC_KEY                    : "https://base-sepolia-rpc.publicnode.com",
